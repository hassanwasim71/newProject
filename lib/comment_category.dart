                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                            ...
                            Text('Dislike',style:TextStyle(fontWeight: FontWeight.bold,color:Colors.grey[700])))
                        ,
                          GestureDetector(
                              onTap: () async{
                              ...
                              child: Text('Post Solution',style:TextStyle(fontWeight: FontWeight.bold,color:Colors.grey[700]))
                          ),
